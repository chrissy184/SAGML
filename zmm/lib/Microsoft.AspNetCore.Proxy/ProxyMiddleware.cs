...
namespace Microsoft.AspNetCore.Proxy
{
    ...
    public class ProxyMiddleware
    {
        ...
        public Task Invoke(HttpContext context)
        {
            ...
            PathString proxyPath = context.Request.Path;
            HostString proxyHost = Maps.ResolveProxyHostPortAndPath(context.Request.Path.Value.ToString(), ref proxyPath);
            var uri = new Uri(UriHelper.BuildAbsolute(_options.Scheme, proxyHost , _options.PathBase, proxyPath, context.Request.QueryString.Add(_options.AppendQuery)));
