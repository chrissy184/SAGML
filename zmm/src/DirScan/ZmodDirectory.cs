...
namespace ZMM.DS
{
    ...
    {        
        ...
        public Dictionary<string, JsonModelFileInfo> JsonModelFiles { get; set; } =
            new Dictionary<string, JsonModelFileInfo>();
        ...
        public void Refresh()
        {
            ...
            JsonModelFiles = (from _ in Directory.GetFiles(ModelDir, "*.json", SearchOption.AllDirectories)
                    select _).ToDictionary(x => new RaiFile(x).NameWithExtension, x => new JsonModelFileInfo(x));
